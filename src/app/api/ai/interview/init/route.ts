...
export async function POST(req: NextRequest) {
  try {
    ...
    const initPrompt = `
      You are an AI interviewer named "Hiremantis AI" for ${
        job.companyName
      ...
      1. Introduction: Introduce yourself as "Hiremantis AI" with a brief welcome message and explain the interview process.
