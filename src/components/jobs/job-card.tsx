...
export function JobCard({ job }: JobCardProps) {
  ...
  return (
    <Link href={`/jobs/${job.urlId}`} className="block h-full">
      <Card className="h-full transition-all duration-300 hover:shadow-md hover:border-primary/30 bg-background/70 backdrop-blur-sm border border-primary/10 cursor-pointer">
